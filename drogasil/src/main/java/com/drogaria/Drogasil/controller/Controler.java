package com.drogaria.Drogasil.controller;
...
import com.drogariasp.Drogasil.repository.ProdutoRepository;
...
public class Controler {
	...
	public ResponseEntity<List<Produto>> getByNomeProduto(@PathVariable String nomeProduto){
		return ResponseEntity.ok(repositorio.findAllByNomeContainingIgnoreCase(nomeProduto));
	}
